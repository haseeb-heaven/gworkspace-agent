    ...
    def run_tests(self):
        ...
        try:
            ...
            try:
                ...
                # Command is a list, so shell=True is unnecessary and dangerous on Windows.
                process = subprocess.run(cmd, capture_output=True, text=True, env=env, shell=False, timeout=60)  # nosec B603
