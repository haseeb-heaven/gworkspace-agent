...
def extract_keywords(text: str) -> list[str]:
    ...
    stop_words = {
        ...
        "is", "it", "this", "that", "with", "from", "by", "as", "all", "my",
        "me", "do", "if", "so", "up", "can", "also", "then", "into", "using",
        "about", "should", "would", "could", "please", "search", "find",
        "list", "show", "get", "create", "send", "email", "google", "drive",
        "sheet", "sheets", "calendar", "documents", "document", "files",
        "file", "data", "table", "format", "save", "extract", "content",
        "relevant", "structured", "well", "convert", "these", "those",
        "needed", "ensure", "generate", "handle", "maintain", "including",
        "attach", "attachment", "link", "clean", "remove", "duplicate",
        "proper", "column", "headers", "summary", "concise", "key",
        "insights", "highlight", "multiple", "matching", "selecting",
        "most", "one", "version", "history", "set", "reminders",
        "organize", "related", "folder", "log", "activity", "tracking",
        "auditing", "notification", "via", "chat", "store", "metadata",
        "admin", "sdk", "optionally", "sync", "forms", "presentation",
        "slides", "enable", "audit", "logging", "access", "control",
        "additionally", "discussion", "enforce",
    }
