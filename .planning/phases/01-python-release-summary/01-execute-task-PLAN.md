...
## Tasks
- [x] **Task 1: Run the gws_cli task** `type="auto"`
...
- [x] **Task 2: Verify output links** `type="auto"`
...
- [x] Google Doc link generated.
- [x] Google Sheet link generated.
- [x] Email sent (verified by output).
