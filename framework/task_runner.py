...
class TaskRunner:
    ...
    def run_tests(self):
        ...
        try:
            ...
            try:
                # Security note: shell=False is used to prevent shell injection vulnerabilities.
                # Passing a list with shell=True on Windows interprets the entire string, which is unsafe.
