...
class TaskRunner:
    ...
    def run_tests(self):
        ...
        try:
            ...
            try:
                # Security: shell=False prevents shell injection vulnerabilities, especially on Windows where shell=True with a list triggers shell interpretation of metacharacters.
