...
def test_manual_1():
    run_task("Create a Keep note titled 'Manual Test Validation: Phase 4 Keep' with the body 'Hello from GWS Agent testing phase. This is the manual test validation for Keep.'")
