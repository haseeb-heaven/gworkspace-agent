...
def test_filter_gmail_messages_basic():
    messages = [
        {"snippet": "Here is the budget report", "payload": {"headers": [{"name": "Subject", "value": "Budget 2024"}]}},
        {"snippet": "Lunch tomorrow?", "payload": {"headers": [{"name": "Subject", "value": "Lunch"}]}},
    ]
    keywords = ["budget"]
    ...
    messages = [
        {
            "snippet": "Checking in",
            "payload": {
                "headers": [{"name": "From", "value": "boss@company.com"}, {"name": "Subject", "value": "Urgent"}]
            },
        }
    ]
    # Match on Subject
