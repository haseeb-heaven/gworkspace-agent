...
@pytest.mark.manual
def test_scenario_15_drive_cleanup_by_type():
    """Manual test for scenario_15_drive_cleanup_by_type"""
    scenario = next(s for s in SCENARIOS if s["id"] == "scenario_15_drive_cleanup_by_type")
